    ...
    $.fn.percircle = function(options) {
        ...
        return this.each(function(){
            ...
            if (!perclock) {
                ...
                var icon = percircle.attr('data-icon') || options.icon || null;

                if(icon !== null){
                  $('<span><i class="material-icons">'+icon+'</i></span>').appendTo(percircle);
                }else{
                  $('<span style="padding-top:55%">'+text+'</span> <span >'+percent+'%</span>').appendTo(percircle);
                }
